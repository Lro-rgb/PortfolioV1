...
(function () {
  ...
  var translations = {
    de: {
      ...
      "home.credits": "<p class=\"quellen-intro\">Was auf dieser Seite nicht von mir ist:</p><dl class=\"quellen-liste\"><div class=\"q-e\"><dt>Visual Studio Code</dt><dd>Microsoft. Die Oberfläche ist dem Editor nachgebaut, ebenso die Farbdesigns Dark+ und Light+.</dd></div><div class=\"q-e\"><dt><a href=\"https://devicon.dev\" target=\"_blank\" rel=\"noopener noreferrer\">Devicon 2.16.0</a></dt><dd>Die Technologie-Logos bei Skills, Tech-Stack, Explorer und Tableiste. MIT-Lizenz.</dd></div><div class=\"q-e\"><dt>JetBrains Mono</dt><dd>Die Schrift für Code und Beschriftungen. JetBrains, SIL Open Font License.</dd></div><div class=\"q-e\"><dt>Inter</dt><dd>Die Schrift für den Fliesstext. Rasmus Andersson, SIL Open Font License.</dd></div><div class=\"q-e\"><dt><a href=\"https://stats.fm\" target=\"_blank\" rel=\"noopener noreferrer\">stats.fm</a></dt><dd>Meine Hördaten bei den Interessen. Die Cover kommen von Spotify und Apple Music.</dd></div><div class=\"q-e\"><dt>Weitere Farbdesigns</dt><dd>Dracula (Zeno Rocha), Nord (Sven Greb), One Dark (Atom) und GitHub Dark — alle MIT-Lizenz.</dd></div></dl><p class=\"quellen-fuss\">Text, Aufbau, CSS, JavaScript, die Serverfunktionen und die Bilder der Projekte sind von mir. Die Bildquellen meiner ersten Website stehen <a href=\"erste-website/quellen.html\" target=\"_blank\" rel=\"noopener noreferrer\">dort auf ihrer eigenen Seite</a>.</p>",
