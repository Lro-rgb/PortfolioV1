...
(function () {
  ...
  var translations = {
    de: {
      ...
      "skills.intro": "<p>Neben jeder Technologie steht das Projekt, in dem ich sie eingesetzt habe — ein Klick darauf führt hin. Was ich dort genau gebaut habe, steht bei den Projekten.</p>",
    ...
    en: {
      ...
      "tabbar.close.projekte": "Close projekte.html",
      "tabbar.close.interessen": "Close interessen.json",
      "tabbar.close.kontakt": "Close kontakt.sql",
      ...
      "skills.intro": "<p>Next to each technology is the project where I used it — click it to jump straight there. What exactly I built is described over in the projects section.</p>",
