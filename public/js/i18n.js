...
(function () {
  ...
  var translations = {
    ...
    en: {
      ...
      "home.credits": "<p class=\"quellen-intro\">What on this page isn't mine:</p><dl class=\"quellen-liste\"><div class=\"q-e\"><dt>Visual Studio Code</dt><dd>Microsoft. The interface is a rebuild of the editor, as are the Dark+ and Light+ colour themes.</dd></div><div class=\"q-e\"><dt><a href=\"https://devicon.dev\" target=\"_blank\" rel=\"noopener noreferrer\">Devicon 2.16.0</a></dt><dd>The technology logos in skills, tech stack, explorer and tab bar. MIT licence.</dd></div><div class=\"q-e\"><dt>JetBrains Mono</dt><dd>The typeface for code and labels. JetBrains, SIL Open Font License.</dd></div><div class=\"q-e\"><dt>Inter</dt><dd>The typeface for body text. Rasmus Andersson, SIL Open Font License.</dd></div><div class=\"q-e\"><dt><a href=\"https://stats.fm\" target=\"_blank\" rel=\"noopener noreferrer\">stats.fm</a></dt><dd>My listening data in the interests section. Cover art comes from Spotify and Apple Music.</dd></div><div class=\"q-e\"><dt>Further colour themes</dt><dd>Dracula (Zeno Rocha), Nord (Sven Greb), One Dark (Atom) and GitHub Dark — all MIT licence.</dd></div><div class=\"q-e\"><dt>Google Maps</dt><dd>The map material in the Askel screen recording. The recording itself and the app are mine, respectively the project team's.</dd></div><div class=\"q-e\"><dt>Tools I used</dt><dd>For topics my classes haven't covered yet — securing the protected area and tracking down stubborn bugs — I worked with Claude Code and read up in documentation and blogs, mostly MDN and the Node docs. More on that in <code>readme.md</code>.</dd></div></dl><p class=\"quellen-fuss\">Text, structure, CSS, JavaScript, the server functions and the project images are mine. The image sources for my first website are listed <a href=\"erste-website/quellen.html\" target=\"_blank\" rel=\"noopener noreferrer\">on its own page</a>.</p>",
